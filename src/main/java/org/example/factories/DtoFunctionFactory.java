...
public class DtoFunctionFactory {
    ...
    public ClubToResponseFunction clubToResponse() {
        return new ClubToResponseFunction();
    }

    public ClubsToResponseFunction clubsToResponse() {
        return new ClubsToResponseFunction();
    }

    public RequestToClubFunction requestToClub() {
        return new RequestToClubFunction();
    }
    ...
    public RequestToPlayerFunction2Params requestToPlayer2Params() {
        return new RequestToPlayerFunction2Params();
    }
    public UpdateClubWithRequestFunction updateProperty() {
        return new UpdateClubWithRequestFunction();
    }
